      ...
      <nav className={cn(
        ...
        <div className="container mx-auto px-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Button asChild variant="ghost" className={cn("font-bold", isScrolled ? "text-foreground" : "text-white hover:bg-white/10")}>
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="container relative z-10 px-6 text-center space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-1000">
          ...
          <div className="flex flex-col items-center justify-center gap-3 pt-4 w-full max-w-xs mx-auto">
            {user ? (
              <Button asChild size="lg" className="w-full h-12 px-8 rounded-full text-sm font-black shadow-2xl shadow-primary/40 active:scale-95 transition-all">
                <Link href="/dashboard">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto items-stretch">
            ...
            <Card className="rounded-[2.5rem] border-none shadow-xl overflow-hidden flex flex-col bg-white ring-1 ring-black/5">
              ...
              <CardFooter className="p-8 pt-0">
                <Button asChild variant="outline" className="w-full h-12 rounded-xl font-black uppercase text-xs border-2">
            ...
            <Card className="rounded-[2.5rem] border-none shadow-2xl overflow-hidden flex flex-col bg-black text-white ring-4 ring-primary relative scale-105 z-10">
              ...
              <CardFooter className="p-8 pt-0">
                <Button asChild className="w-full h-12 rounded-xl font-black shadow-xl bg-white text-black hover:bg-white/90 text-xs">
                  <Link href="/signup">Upgrade Squad</Link>
                </Button>
              </CardFooter>
            </Card>
            ...
            <Card className="rounded-[2.5rem] border-none shadow-xl overflow-hidden flex flex-col bg-white ring-1 ring-black/5">
              ...
              <CardFooter className="p-8 pt-0">
                <Button asChild variant="outline" className="w-full h-12 rounded-xl font-black uppercase text-xs border-2">
                  <Link href="/signup">Deploy Club</Link>
                </Button>
              </CardFooter>
            </Card>
            ...
            <Card className="rounded-[2.5rem] border-none shadow-xl overflow-hidden flex flex-col bg-white ring-1 ring-black/5">
              ...
              <CardFooter className="p-8 pt-0">
                <Button asChild variant="outline" className="w-full h-12 rounded-xl font-black uppercase text-xs border-2">
                  <Link href="/signup">Deploy League</Link>
                </Button>
              </CardFooter>
            </Card>
          </div>
